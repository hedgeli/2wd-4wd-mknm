...
import zyrot_motctl_regs_obj as zyregs
...
#     print('send_frame_bytearray ',send_frame_bytearray)
    ...
    send_frame_bytearray = prepare_frm(SelfAddr = 0x01,
                             Fcode = FCODE_WRITE_REGS,
                             RegNum = 4,RegAddr = zyregs.ZYRot_motctl_regs_obj.FCODE_REG_ADDR_BASE,
                             RegVals = [zyregs.ZYRot_motctl_regs_obj.FCODE_SET_V_W_T,
                                        200,0,2000],
                             ByteOrder = '>',Valfmt = 'h')
    print('send_frame FCODE_SET_V_W_T:')
    zyrot_utils.printhex(send_frame_bytearray)
